...
namespace PasswordValidate
{
    public class Startup
    {
        ...
        //Método chamado na execução (runtime). Usar aqui para adicionar serviços
        ...
        //Método chamado na execução (runtime). Usar aqui para configurar a pipeline de requests HTTP
